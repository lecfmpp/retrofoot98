...
(function(){
  ...
  const LEAGUES = {
    ...
    'ESP-2': { name:'La Liga 2',             mvl:0.72, ovrCommon:[63,72], ovrCap:77 },
    'GER-2': { name:'2. Bundesliga',         mvl:0.68, ovrCommon:[62,72], ovrCap:76 },
    'ITA-2': { name:'Serie B',               mvl:0.64, ovrCommon:[62,71], ovrCap:76 },
    'POR-2': { name:'Liga Portugal 2',       mvl:0.32, ovrCommon:[56,66], ovrCap:72 },
