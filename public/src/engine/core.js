...
const UNI_CONFIGS={
  ...
  Argentina: { order:['ARG'], size:{ARG:28}, promo:{ARG:0}, releg:{ARG:0}, label:{ARG:'Liga Profesional'}, lg:{ARG:'ARG-1'}, country:'Argentina', nat:['Argentina'], foreignMax:6, src:'conmebol' },
